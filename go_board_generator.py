"""
Go Board Generator - Creates a 9x9 Go board PDF with Japanese standard dimensions
...
h_spacing_mm = 22.00
v_spacing_mm = 23.70
left_right_margin_mm = 14.10
top_bottom_margin_mm = 13.95
...
# Create canvas
c = canvas.Canvas("go_board_9x9_japanese_standard.pdf", pagesize=A4)
...
attribution_text = "Generated by Go Board Generator - github.com/[yourusername]/GoBoard"
c.drawString(PAGE_WIDTH - 200, 20, attribution_text)

# Save PDF
c.save()
print("PDF created: go_board_9x9_japanese_standard.pdf")